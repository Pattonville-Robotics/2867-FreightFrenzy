...
@Autonomous(name="WarehousePark_BlueLeft", group="Autonomous")
public class WarehousePark_BlueLeft extends LinearOpMode {
    @Override
    public void runOpMode() throws InterruptedException {
        WarehousePark.run(this, AllianceSide.BLUE, AlliancePosition.LEFT);
    }
}
